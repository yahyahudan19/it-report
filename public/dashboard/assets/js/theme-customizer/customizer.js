      ...
      <section class="layout-sidebar">
        <div class="customizer-header">
          <div class="theme-title">
            <div>
              <h4>Preview Halo Settings</h4>
              <p class="mb-0">Try It Real Time<i class="fa-solid fa-thumbs-up fa-fw"></i></p>
            </div>
            <div class="flex-grow-1">
              <a class="icon-btn btn-outline-light button-effect pull-right grip-close" id="grip-close">
        ...
        <div class="customizer-body custom-scrollbar">
          ...
          <ul class="layout-grid sidebar-type layout-types">
            <li data-attr="compact-sidebar">
              <div class="layout-img">
                <a href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/dubai.jpg">
                </a>
                <h6>Dubai</h6>
              </div>
            </li>
            <li data-attr="material-layout">
              <div class="layout-img">
                <a href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/los-angle.png">
                </a>
                <h6>Los Angeles</h6>
              </div>
            </li>
            <li data-attr="dark-sidebar">
              <div class="layout-img">
                <a href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/paris.jpg">
                </a>
                <h6>Paris</h6>
              </div>
            </li>
            <li data-attr="compact-wrap">
              <div class="layout-img">
                <a href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/tokyo.jpg">
                </a>
                <h6>Tokyo</h6>
              </div>
            </li>
            <li data-attr="compact-small">
              <div class="layout-img">
                <a href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/moscow.jpg">
                </a>
                <h6>Moscow</h6>
              </div>
            </li>
            <li data-attr="enterprice-type">
              <div class="layout-img">
                <a href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/singapore.jpg">
                </a>
                <h6>Singapore</h6>
              </div>
            </li>
            <li class="box-layout" data-attr="box-layout">
              <div class="layout-img">
                <a href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/newyork.png">
                </a>
                <h6>New York</h6>
              </div>
            </li>
            ...
            <li data-attr="material-icon">
              <div class="layout-img">
                <a href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/rome.jpg">
                </a>
                <h6>Rome</h6>
              </div>
            </li>
            <li data-attr="modern-layout">
              <div class="layout-img">
                <dashboard href="javascript:void(0)">
                  <img alt="" class="img-fluid" src="dashboard/assets/images/landing/layout-images/dubai.jpg">
                </dashboard

      ...
      function _buildInputGroup() {
        ...
        if (settings.verticalbuttons) {
          html =
            ...
            settings.prefix +
            '</span><span class="input-group-text bootstrap-touchspin-postfix">' +
            settings.postfix +
